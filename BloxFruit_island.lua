...
local function Alive()
   if Char then
      if getRoot(Char) and getHumanoid(Char) then
         if getHumanoid(Char).Health > 0 then
            return true
         end
      end
   end
...
local function Equip(Tool)
   pcall(function()
      ...
      if getHumanoid(Char) and not Char:FindFirstChild(Tool) then
         getHumanoid(Char):EquipTool(ToolEquip)
      end
   end)
end
--For Auto Chest
...
local function NoclipLoop()
   if NoClip == true and Char ~= nil and not DisabledNoClip then
...
local function IsAlive(Mob)
   if Mob and Mob.Parent and getRoot(Mob) and getHumanoid(Mob) then
      if getHumanoid(Mob).Health > 0 then
         return true
      end
   end
   return false
...
--Check Magnitude
local function CheckMagnitude(Object1,Object2,Dist)
   ...
   if getgenv().AutoFarmBring and DoMagnet then
      for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
         if IsAlive(v) and not Tweening  then
            if Alive() and CheckMagnitude(v,Char,1000) then 
               if v.Name == NameMob or (string.find(v.Name,CurrentMobName) and string.find(v.Name,HighestLvToFarm) ) or string.find(v.Name,SpecialMob) and not string.find(v.name,"Boss") then
                  pcall(function()
                     ...
                     if BringCFrame~= nil and BringPos ~= nil then
                        if CheckMagnitude(v,Char,300) then
                           getRoot(v).CFrame = BringCFrame
                           getRoot(v).Position = BringPos
                           ResizeHRP(v,true)
                           getHumanoid(v).PlatformStand = true
                        end
                     end
                  end)
               end
...
local function BringMobNear()
   if getgenv().AutoFarmBring then
      for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
         if IsAlive(v) and not Tweening then
            if Alive() and CheckMagnitude(v,Char,1000) then -- and string.find(v.Name,HighestLvToFarm) and not BringBone  
               pcall(function()
                  getRoot(v).Velocity = Vector3.new(1,1,1)
                  if BringCFrame~= nil and BringPos ~= nil then
                     if CheckMagnitude(v,Char,300) then
...
local function GetQuest()
   ...
   if getgenv().AutoFarmQuest then
      if Alive() and getgenv().AutoFarm and LP.PlayerGui.Main.Quest.Visible == false or not string.find(LP.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,CurrentMobName) then
         ...
         CheckFloat1()
         if (getRoot(Char).Position- Vector3.new(QuestCFrame)).magnitude < 50 then
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/vinhuchi/BloxFruit/main/functions2.lua"))()
...
spawn(function()
   while getgenv().AutoSuperHuman and wait() do
      ...
      if not getgenv().HaveFishmanKarate then
         ...
         local FishmanKarate = LP.Backpack:FindFirstChild("FishmanKarate") or Char:FindFirstChild("FishmanKarate")
      ...
      local DragonClaw = LP.Backpack:FindFirstChild("DragonClaw") or Char:FindFirstChild("DragonClaw")
      ...
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
      Superhuman = LP.Backpack:FindFirstChild("Superhuman") or Char:FindFirstChild("Superhuman")
      if Superhuman then
         Weapon = Superhuman
...
spawn(function()
   while task.wait() do
      if getgenv().AutoBuso and not Char:FindFirstChild("HasBuso") then
         local args = {
            [1] = "Buso"
         }
         game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
      ...
      if getgenv().FullyAutolawRaid or getgenv().AutoAllBoss or getgenv().AutoFarm or getgenv().MobAura or getgenv().AutoFarmCandy or getgenv().AutoFarmBone then
            ...
            if Alive() then
               for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                  if not FirstSea then
                     if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm and string.find(v.Name,CurrentMobName) and string.find(v.Name,HighestLvToFarm) then
                        if getHumanoid(v) and getHumanoid(v).Health > 0 and v.Parent and getRoot(v) then
                           if SmallestDistance > (getRoot(v).Position-getRoot(Char).Position).magnitude then
                              SmallestDistance = (getRoot(v).Position-getRoot(Char).Position).magnitude
                              MobToFarm = v
                           end
                        end
               ...
               repeat task.wait()
                  if Alive() then
                     ...
                     if Alive() and IsAlive(MobToFarm) and CheckMagnitude(MobToFarm,Char,300) then
                        spawn(function()
                        ...
                        if getRoot(Char).Position.y - getRoot(MobToFarm).Position.y > -5  then
                           if getRoot(MobToFarm).Position.Y - OldY >= 0 then
                              spawn(function()
                                 ...
                                 if getgenv().AutoFarm and MobToFarm.Parent and MobToFarm:FindFirstChild("Humanoid") and MobToFarm:FindFirstChild("HumanoidRootPart") ~= nil then
                                    if Alive() and MobToFarm:FindFirstChild("Humanoid").Health > 0 and (getRoot(MobToFarm).Position-HumanoidRootPart.Position).magnitude <= 300 then
                                       CheckFloat1()
                                       getRoot(Char).CFrame = getRoot(MobToFarm).CFrame * CFrame.new(0, 0, 30)
                                    else
                                       TPSpecificPlace()
                                       DoTween(getRoot(MobToFarm).CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                                       CheckFloat1()
                        ...
                        elseif getgenv().AutoFarm then
                           ...
                           if randomnumber == 1 then
                              getRoot(Char).CFrame = getRoot(MobToFarm).CFrame * CFrame.new(0, 30, 0)      
                     ...
                     elseif not Tweening and IsAlive(MobToFarm) and Alive() then  
                        ...
                        DoTween(getRoot(MobToFarm).CFrame* CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                        CheckFloat1()
                        if IsAlive(MobToFarm) and Alive() and not CheckMagnitude(MobToFarm,Char,300) then
                           TPSpecificPlace()
                           DoTween(getRoot(MobToFarm).CFrame* CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                           CheckFloat1()
                        end
                     ...
                     if MobHumanoid and MobHRP and getgenv().AutoFarmGunMastery then
                        ...
                        if MobHumanoid.Health > 0 then
                           if MobHumanoid.Health > (MobHumanoid.MaxHealth*getgenv().HealthMastery)/100 then
                              ...
                              getRoot(v).CanCollide = false
                              getRoot(v).Size = Vector3.new(60,60,60)
                              if HumanoidRootPart.Position.y >= getRoot(v).Position.y then
                                       ...
                                       if getgenv().AutoFarmGunMastery then
                                          if MobP and MobHumanoid and MobHRP then
                                             if Alive() and MobHumanoid.Health > 0 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                                ...
                                                HumanoidRootPart.CFrame = getRoot(v).CFrame * CFrame.new(x, getgenv().Y, z)
                                             else
                                                DoTween(getRoot(v).CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                                             end
                                          end
                                 ...
                                 if getgenv().AutoFarmGunMastery then
                                    if (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                       CheckFloat1()
                                       local randomnumber = math.random(1,3)
                                       if randomnumber == 1 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                          CheckFloat1()
                                          getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 0, 30)      
                                       elseif randomnumber ==2 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                          CheckFloat1()
                                          getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 0, -30) 
                                       elseif randomnumber ==3 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                          CheckFloat1()
                                          getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, -30, 0)
                                       end    
                                    else
                                       DoTween(getRoot(v).CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                                    end
                              ...
                              getgenv().SilentAimMob = true
                              spawn(function()
                                 while getgenv().UsingGunMas == true and getgenv().AutoFarmGunMastery and  v.Parent and v:FindFirstChild("Humanoid") and  v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and v:FindFirstChild("Humanoid").Health > 0  do
                                    wait()
                                    if (getRoot(v).Position-getRoot(Char).Position).magnitude <= 300 then
                              ...
                              --pcall(function()
                                 ...
                                 if Char:FindFirstChild(GunFarmMas) and getgenv().SkillZGun and v.Humanoid.Health <= (v:FindFirstChild("Humanoid").MaxHealth*getgenv().HealthMastery)/100 and require(Char:FindFirstChild(GunFarmMas).Data).Lvl.Z <= Char:FindFirstChild(GunFarmMas).Level.Value then
                                    VIM:SendKeyEvent(true,"Z",false,game)
                                    VIM:SendKeyEvent(false,"Z",false,game)
                                 end
                                 if Char:FindFirstChild(GunFarmMas) and getgenv().SkillXGun and v.Humanoid.Health <= (v:FindFirstChild("Humanoid").MaxHealth*getgenv().HealthMastery)/100 and require(Char:FindFirstChild(GunFarmMas).Data).Lvl.X <= Char:FindFirstChild(GunFarmMas).Level.Value then
                        ...
                        if MobHumanoid.Health > (MobHumanoid.MaxHealth*getgenv().HealthMastery)/100 then
                                       ...
                                       if MobP and MobHumanoid and MobHRP then
                                          if Alive() and MobHumanoid.Health > 0 then
                                             if (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                                CheckFloat1()
                                                --local x,z = RandomNumberF()
                                                HumanoidRootPart.CFrame = getRoot(v).CFrame * CFrame.new(0,0,30)
                                             else
                                                DoTween(getRoot(v).CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                                                CheckFloat1()
                                             end
                           ...
                           elseif game.Players.LocalPlayer.Data.DevilFruit.Value ~= "Control-Control" then
                              ...
                              pcall(function()
                                 ...
                                 if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) and getgenv().SkillX and v.Humanoid.Health <= (v:FindFirstChild("Humanoid").MaxHealth*getgenv().HealthMastery)/100 and game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills[game.Players.LocalPlayer.Data.DevilFruit.Value].X.Cooldown.AbsoluteSize.X == 0 and not UsingSkill and getgenv().AutoFarmFruitMastery and require(Char:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value).Data).Lvl.X <= Char:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value).Level.Value then
                                    UsingSkill = true
                                    VIM:SendKeyEvent(true,"X",false,game)
   ...
   while wait()  do
      ...
      if getgenv().AutoAllBoss then
         ...
         pcall(function()
               ...
               if v then
                  ...
                  if BossLevel ~= nil and PlrLevel ~= nil then
                     if getgenv().AutoAllBoss and v.Name ~= "Longma [Lv. 2000] [Boss]" and v.Name ~= "Order [Lv. 1250] [Raid Boss]" and v.Name ~= "Cursed Captain [Lv. 1325] [Raid Boss]" and v.Name ~= "rip_indra [Lv. 1500] [Boss]" and v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and tonumber(BossLevel) <= PlrLevel and string.find(v.Name,"Boss") then
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid").Health > 0 and (getRoot(v).Position-HumanoidRootPart.Position).magnitude < NearestDist then
                           NearestBoss = v
                           NearestDist =  (getRoot(v).Position-HumanoidRootPart.Position).magnitude
                        end
                     end
                  end
               end
            ...
            CheckQuestBoss()
            if NearestBoss then
               OldY = NearestBoss.HumanoidRootPart.Position.Y
               OldCFrame = NearestBoss.HumanoidRootPart.CFrame
               ...
               if getgenv().AutoFarmQuest and QuestNameBoss then
                  ...
                  if Alive() and getgenv().AutoAllBoss and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                     if NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("Humanoid").Health > 0 and  NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and getgenv().AutoAllBoss then
                        DoTween(QuestCFrameBoss,getgenv().TweenSpeedQuest)
                        if (getRoot(Char).Position- Vector3.new(QuestCFrameBoss)).magnitude < 50 then
               ...
               --Tp To Boss
               if NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("Humanoid").Health > 0 and  NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and getgenv().AutoAllBoss then
                  DisabledNoClip = true
                  DoTween(NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                  DisabledNoClip = false
               end
               repeat wait()
                  ...
                  if Alive() then
                     ...
                     FastAttack()
                     -- HitBoxPlr()
                     NearestBoss.HumanoidRootPart.CanCollide = false
                     NearestBoss.HumanoidRootPart.Size = Vector3.new(300,300,300)
                     DisabledNoClip = true

                     if getgenv().AutoAllBoss and NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and NearestBoss:FindFirstChild("Humanoid").Health > 0 and (NearestBoss.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then

                        if getRoot(Char).Position.y - NearestBoss.HumanoidRootPart.Position.y > -3 then
                           if NearestBoss.HumanoidRootPart.Position.Y - OldY >= 0 then
                              spawn(function()
                                 wait()
                                 if getgenv().AutoAllBoss and NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil then
                                    if Alive() and NearestBoss:FindFirstChild("Humanoid").Health > 0 and (NearestBoss.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                       CheckFloat1()
                                       HumanoidRootPart.CFrame = NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0, 40, 40)
                                    else
                                       DoTween(NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                                    end
                                 end
                        ...
                        elseif getgenv().AutoAllBoss then
                           local randomnumber = math.random(1,3)
                           if randomnumber == 1 then
                              HumanoidRootPart.CFrame = NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)      
                           elseif randomnumber ==2 then
                              HumanoidRootPart.CFrame = NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0, 0, -50) 
                           elseif randomnumber ==3 then
                              HumanoidRootPart.CFrame = NearestBoss.HumanoidRootPart.CFrame * CFrame.new(0, -50, 0)
                           end    
                        end
                     ...
                     elseif not Tweening and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("Humanoid").Health > 0 and Alive() then  
                        DoTween(NearestBoss.HumanoidRootPart.CFrame* CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        if NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and NearestBoss:FindFirstChild("Humanoid").Health > 0 and (NearestBoss.HumanoidRootPart.Position-getRoot(Char).Position).magnitude > 300 then
                           DoTween(NearestBoss.HumanoidRootPart.CFrame* CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        end
                     end
                  else wait(5)
                  end
               until not NearestBoss.Parent or NearestBoss:FindFirstChild("Humanoid") == nil or NearestBoss.Humanoid.Health <= 0 or NearestBoss:FindFirstChild("HumanoidRootPart") == nil or not Alive() or getgenv().AutoAllBoss == false
            end
         end)
      end
   end
         ...
         if MobObservation ~= nil and PosObservation ~= nil then
            if game.Workspace.Enemies:FindFirstChild(MobObservation) then
               if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                  ...
                  repeat wait()
                     if (getRoot(Char).Position-game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.Position).magnitude < 300 then
                        getRoot(Char).CFrame = game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                     else
                        DoTween(game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame* CFrame.new(3,0,0),getgenv().TweenSpeedAutoFarm)
                     end
                  ...
                  repeat wait()
                     if not  game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                        CheckFloat1()
                        if (getRoot(Char).Position-game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.Position).magnitude < 300 then
                           getRoot(Char).CFrame = game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame * CFrame.new(30,30,30)
                        else
      ...
      pcall(function()
            ...
            if Alive() then
               ...
               if getgenv().AutoSetSpawn and getgenv().AutoFarm2 and Alive() then
                  --if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and getgenv().AutoFarm2 and game:GetService("Players").LocalPlayer.Data.SpawnPoint.Value ~= SpawnPoint and CanTween then
                     --DoTween(SpawnCFrame,getgenv().TweenSpeedTeleportPlace)
                     local args = {
                        [1] = "SetSpawnPoint"
                     }
                           ...
                           if getgenv().AutoFarm2 and Alive() then
                              ...
                              for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                 if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm2 and v.Name == NameMob then
                                    if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") and (getRoot(v).Position-FarmingPlace1.Position).magnitude <= 450 then
                     ...
                     if getgenv().AutoFarm2 then
                        ...
                        if getgenv().AutoFarm2 then
                           ...
                           if getgenv().AutoFarm2 and Alive()  then
                              ...
                              for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                 if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm2 and v.Name == NameMob then
                                    if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") and (getRoot(v).Position-FarmingPlace2.Position).magnitude <= 350 then
   ...
   while getgenv().MobAura and task.wait() do
      ...
      for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
         if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 then
            if (getRoot(v).Position-getRoot(Char).Position).magnitude <= 3000 then
               if (getRoot(v).Position-getRoot(Char).Position).magnitude < NearestDist then
                  NearestDist = (getRoot(v).Position-getRoot(Char).Position).magnitude
                  NearestMob = v
               end
            end
         end
      ...
      if NearestMob then
         pcall(function()
            if (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude <= 3000 then
               MobAuraBringPos = NearestMob.HumanoidRootPart.CFrame
               repeat wait()

                  Equip(Weapon)
                  ResizeHRP(NearestMob,false)
                  if (NearestMob.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 350 then
                     getRoot(Char).CFrame = NearestMob.HumanoidRootPart.CFrame * CFrame.new(0, 0, 60)
                  else
                     DoTween(NearestMob.HumanoidRootPart.CFrame,getgenv().TweenSpeedAutoFarm)
                  end
               until not NearestMob.Parent or not NearestMob or not NearestMob:FindFirstChild("HumanoidRootPart") or not NearestMob:FindFirstChild("Humanoid") or NearestMob.Humanoid.Health <= 0 or not getgen().MobAura or (NearestMob.HumanoidRootPart.Position-getRoot(Char).Position).magnitude > 3000
            end
         end)
      end
   end
...
AutoFarm:addToggle("Mob Aura Bring",false,function(boolen)
   ...
   while getgenv().MobAura and task.wait() do
      ...
      if NearestMob then
         pcall(function()
            if (NearestMob.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 3000 then
               MobAuraBringPos = NearestMob.HumanoidRootPart.CFrame
               if Alive() and NearestMob:FindFirstChild("Humanoid") and NearestMob.Humanoid.Health > 0 and NearestMob.Parent and NearestMob:FindFirstChild("HumanoidRootPart") then
                  BringCFrame = NearestMob.HumanoidRootPart.CFrame
                  BringPos = NearestMob.HumanoidRootPart.Position
               end
               repeat wait()
                  spawn(function()
                  ...
                  NearestMob.HumanoidRootPart.Size = Vector3.new(200, 50, 200)
                  if (NearestMob.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 350 then
      ...
      while getgenv().AutoSeaBeast and task.wait() do
         ...
         for i,v in pairs(game.Workspace.SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
               if (v:FindFirstChild("HumanoidRootPart").Position-getRoot(Char).Position).magnitude < NearestDistSeaBeast then
                  NearestSeaBeast = v
                  NearestDistSeaBeast = (v:FindFirstChild("HumanoidRootPart").Position-getRoot(Char).Position).magnitude
               end
            end
         end
         pcall(function()
            ...
            repeat wait()
               spawn(function()
                  if WeaponSkill1 ~= nil and getgenv().AutoSeaBeast and Alive() then
                     Equip(WeaponSkill1)
                     wait()
                     if Char:FindFirstChild(WeaponSkill1) then
                        Click()
                     end
                     VIM:SendKeyEvent(true,"Z",false,game)
                     VIM:SendKeyEvent(false,"Z",false,game)
                  ...
                  if WeaponSkill2 ~= nil and getgenv().AutoSeaBeast and Alive() then
                     Equip(WeaponSkill2)
                     wait()
                     if Char:FindFirstChild(WeaponSkill2) then
                        Click()
                        VIM:SendKeyEvent(true,"Z",false,game)
                        VIM:SendKeyEvent(false,"Z",false,game)
                        wait()
               ...
               if ((NearestSeaBeast.HumanoidRootPart.Position+Vector3.new(0,300,0))-getRoot(Char).Position).magnitude <= 350 then

                  getRoot(Char).CFrame = NearestSeaBeast.HumanoidRootPart.CFrame * CFrame.new(0, 500, 0)
                  CheckFloat1()
               else
   ...
   while getgenv().KillingBoss and wait() do
      for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
         if v.Name == BossName then
            ...
            --Get Quest
            if getgenv().AutoFarmQuest and QuestNameBoss then
               if Alive() and getgenv().KillingBoss and LP.PlayerGui.Main.Quest.Visible == false then
                  if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 and  v:FindFirstChild("HumanoidRootPart") ~= nil and getgenv().KillingBoss then
                     ...
                     CancelQuest()
                     wait(0.1)
                     if (getRoot(HumanoidRootPart).Position- Vector3.new(QuestCFrameBoss)).magnitude < 50 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest", QuestNameBoss, LvQuestBoss)
                        wait(0.5)
            ...
            repeat wait()
               if Alive() then
                  ...
                  DisabledNoClip = true
                  if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and v:FindFirstChild("Humanoid").Health > 0 then
                     getRoot(v).CanCollide = false
                     getRoot(v).Size = Vector3.new(300,300,300)
                     if (getRoot(v).Position-getRoot(Char).Position).magnitude <= 300 then

                        if getRoot(Char).Position.y - getRoot(v).Position.y > -3 then
                           if getRoot(v).Position.Y - OldY >= 0 then
                              spawn(function()
                                 wait()
                                 if getgenv().KillingBoss and v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil then
                                    if Alive() and v:FindFirstChild("Humanoid").Health > 0 and (getRoot(v).Position-getRoot(Char).Position).magnitude <= 300 then
                                       CheckFloat1()
                                       getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 40, 40)
                                    else
                        ...
                        elseif getgenv().KillingBoss then
                           local randomnumber = math.random(1,3)
                           if randomnumber == 1 then
                              getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 0, 50)      
                           elseif randomnumber ==2 then
                              getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 0, -50) 
                           elseif randomnumber ==3 then
                              getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, -50, 0)
                           end    
                        end
                     ...
                     elseif not Tweening and v:FindFirstChild("HumanoidRootPart") ~= nil and v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 and Alive() then  
                        DoTween(getRoot(v).CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and v:FindFirstChild("Humanoid").Health > 0 and (getRoot(v).Position-getRoot(Char).Position).magnitude > 300 then
                           DoTween(getRoot(v).CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        end
                     end
                  end
...
AutoFarmBoss:addToggle("Silent Aim Boss",false,function(boolen)
   ...
   if getgenv().ChosenBoss ~= nil then
      while getgenv().SilentAimBoss and wait() do
         for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
            if v.Name == getgenv().ChosenBoss and v and v.Humanoid and getRoot(v) then
...
AutoFarmBoss:addButton("Tp to Boss",function()
   if getgenv().ChosenBoss ~= nil then
      ...
      if BossBody then
         local BossHum = BossBody:FindFirstChild("HumanoidRootPart")
         local BossH = BossBody:FindFirstChild("Humanoid")
         if BossHum and BossH then
            local BossHealth = BossH.Health
            if BossHealth > 0 then
               DoTween(BossHum.CFrame,getgenv().TweenSpeedTeleportPlace)
            end
         end
      end
   end
...
local WeaponDropdown = AutoWeapon:addDropdown("Select A Weapon(Melee)",PLrWeapons,function(Value)
   Weapon = Value
end)

local WeaponDropdown2 = AutoWeapon:addDropdown("Select A Weapon(Skill 1)",PLrWeapons,function(Value)
   WeaponSkill1 = Value
end)


local WeaponDropdown3 = AutoWeapon:addDropdown("Select A Weapon(Skill 2)",PLrWeapons,function(Value)
   WeaponSkill2 = Value
end)
...
if SecondSea then
   AutoFarmEvent:addToggle("Auto Ectoplasm",getgenv().AutoEctoplasm,function(boolen)
      ...
      if getgenv().AutoEctoplasm then
         CheckFloat1()
         if (getRoot(Char).Position - Vector3.new(923.21252441406, 125.05710601807, 32852.83203125)).magnitude < 3000 then
      ...
      while getgenv().AutoEctoplasm and wait() do
         ...
         pcall(function()
            if getHumanoid(Char) and getHumanoid(Char).Health > 0 then
               if SecondSea then
                  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                     if (string.find(v.Name,1250) or string.find(v.Name,1275) or string.find(v.Name,1300) or string.find(v.Name,1325)) and not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoEctoplasm then
                        ...
                        if not Tweening then
                           ...
                           if Alive() and (getRoot(Char).Position - Vector3.new(923.21252441406, 125.05710601807, 32852.83203125)).magnitude < 3000 then
                        ...
                        repeat 
                           ...
                           if Alive() and getgenv().AutoEctoplasm then
                              ...
                              if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 and  v:FindFirstChild("HumanoidRootPart") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and v:FindFirstChild("Humanoid").Health > 0 and (getRoot(v).Position-getRoot(Char).Position).magnitude <= 300 then
                                 spawn(function()
                                    ...
                                    HitBoxPlr()
                                    if (getRoot(Char).Position - Vector3.new(923.21252441406, 125.05710601807, 32852.83203125)).magnitude < 3000 then
                                       if getRoot(Char).Position.y > getRoot(v).Position.y then
                                          if getRoot(v).Position.Y - OldY >= 0 then
                                             spawn(function()
                                                wait(1)
                                       ...
                                       getRoot(Char).CFrame = CFrame.new(923.21252441406, 125.05710601807, 32852.83203125)
                                       wait(3)
                                    end
                                 end
   ...
   AutoFarmEvent:addToggle("Auto Factory",false,function(boolen)
      ...
      while getgenv().AutoFactory and wait() do
         pcall(function()
            ...
            if Factory then
               if getHumanoid(Factory) and  getHumanoid(Factory).Health > 0 then
                  if getgenv().AutoFarm then
                     getgenv().AutoFarm = false
                     ChangeAF = true
                  end
                  if (getRoot(Char).Position - FactoryPosition).magnitude > 10 then
                     DoTween(CFrame.new(FactoryPosition),getgenv().TweenSpeedTeleportPlace)
                  else
                     repeat wait()
                        Equip(Weapon)
                        Click()                    
                     until not v or not getHumanoid(Factory) or getHumanoid(Factory).Health <= 0  or not getgenv().AutoFactory or (getRoot(Char).Position - FactoryPosition).magnitude<= 10
                  end
...
if ThirdSea then
            ...
            if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 then
               if ThirdSea then
                  ...
                  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                     if (string.find(v.Name,2200) or string.find(v.Name,2225) or string.find(v.Name,2250) or string.find(v.Name,2275)) and not string.find(v.Name,"Boss") and getgenv().AutoFarmCandy then
                        if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") then
                           if SmallestDistance > (getRoot(v).Position-game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).magnitude then
                              SmallestDistance = (getRoot(v).Position-game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).magnitude
                              MobToFarmCandy = v
                           end
                        end
                     end 
                  ...
                  if MobToFarmCandy then
                     ...
                     if MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and  MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and getgenv().AutoFarmCandy then
                        DoTween(MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                        CheckFloat1()
                     end
                     if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.Health > 0 and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy.Humanoid.Health > 0 and MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("HumanoidRootPart") then
                        BringCFrame = MobToFarmCandy.HumanoidRootPart.CFrame
                        BringPos = MobToFarmCandy.HumanoidRootPart.Position
                     end
                     OldY = MobToFarmCandy.HumanoidRootPart.Position.Y
                     OldCFrame = MobToFarmCandy.HumanoidRootPart.CFrame
                     MobToFarmCandy.HumanoidRootPart.CanCollide = false
                     MobToFarmCandy.HumanoidRootPart.Size = Vector3.new(200,50,200)
                     repeat task.wait()
                        
                        CheckFloat1()
                        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and getgenv().AutoFarmCandy then

                           
                           if MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and  MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and (MobToFarmCandy.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 300 then
                              spawn(function()
                                 if not BringCandy then
                                    BringCandy = true
                                    BringMobNear()
                                    wait(3)
                                    BringCandy = false
                                 ...
                                 HitBoxPlr()
                                 if getRoot(Char).Position.y - MobToFarmCandy.HumanoidRootPart.Position.y > -3 then
                                    if MobToFarmCandy.HumanoidRootPart.Position.Y - OldY >= 0 then
                                       spawn(function()
                                          wait(1)
                                          if getgenv().AutoFarmCandy and MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and  MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil then
                                             if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and (MobToFarmCandy.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 300 then
                                                CheckFloat1()
                                                getRoot(Char).CFrame = MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0, 0, 30)
                                             else
                                                DoTween(MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                                                CheckFloat1()
                                             end
                                       ...
                                       MobToFarmCandy.HumanoidRootPart.CFrame = OldCFrame
                                       wait()
                                       DoTween(MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                                       CheckFloat1()
                                    end
                                    ...
                                    if randomnumber == 1 and getgenv().AutoFarmCandy  then
                                       getRoot(Char).CFrame = MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0)      
                           ...
                           elseif not Tweening and MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil and MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 then  
                              BringCFrame = MobToFarmCandy.HumanoidRootPart.CFrame
                              BringPos = MobToFarmCandy.HumanoidRootPart.Position
                              DoTween(MobToFarmCandy.HumanoidRootPart.CFrame*CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                           end
                     until not MobToFarmCandy.Parent or MobToFarmCandy:FindFirstChild("Humanoid") == nil or MobToFarmCandy.Humanoid.Health <= 0 or MobToFarmCandy:FindFirstChild("HumanoidRootPart") == nil or game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") == nil or game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") == nil or game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0 or getgenv().AutoFarmCandy == false
         ...
         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
            ...
            (v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v:IsA("Model") and string.find(v.Name, "Deandre")) then
               ...
               if v.Parent and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and getgenv().AutoElite then
                  ...
                  repeat wait()
                     Equip(Weapon)
                     if (getRoot(v).Position - getRoot(Char).Position).magnitude <= 350 then
                        getRoot(Char).CFrame = getRoot(v).CFrame * CFrame.new(0, 30, 0)
                     else
                        DoTween(getRoot(v).CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                     end
                     --HitBoxPlr()
                     getRoot(v).Transparency = 1
                     getRoot(v).CanCollide = false
                     getRoot(v).Size = Vector3.new(60,60,60)
                     spawn(function()
                        Click()
   ...
   AutoFarmEvent:addToggle("Auto Pirate Raid",false,function(boolen)
      ...
      while getgenv().AutoPirateRaid and wait() do
         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
            if (v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v:IsA("Model") and (getRoot(v).Position-CenterCastle).magnitude <= 1000) then
         ...
         if PirateRaidStart then
            ...
            if MobPirateRaid then
               ...
               MobPirateRaid:FindFirstChild("HumanoidRootPart").CanCollide = false
               MobPirateRaid:FindFirstChild("HumanoidRootPart").Size = Vector3.new(200,50,200)
               OldY = MobHRP.Position.Y
               OldCFrame = MobHRP.CFrame
               if MobHumanoid and MobHRP and getgenv().AutoPirateRaid and (MobHRP.Position-HumanoidRootPart.Position).magnitude > 300 then
                  if MobHumanoid.Health > 0 and Alive() then
                     DisabledNoClip = true
                     DoTween(MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                     DisabledNoClip = false
                  end
               end
               repeat wait()
                  ...
                  Clicking = true
                  Click()
                  if HumanoidRootPart.Position.y >= MobPirateRaid.HumanoidRootPart.Position.y then
                     if MobPirateRaid.HumanoidRootPart.Position.Y - OldY >= 0 then
                        CheckFloat1()
                        spawn(function()
                           wait()
                           if getgenv().AutoPirateRaid then
                              if MobP and MobHumanoid and MobHRP then
                                 if Alive() and MobHumanoid.Health > 0 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                    CheckFloat1()
                                    local x,z = RandomNumberF()
                                    HumanoidRootPart.CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(x, getgenv().Y, z)
                                 else
                                    DoTween(MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                                 end
                              end
                        ...
                        MobPirateRaid.HumanoidRootPart.CFrame = OldCFrame
                        wait()
                        if getgenv().AutoPirateRaid then
                           DoTween(MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                        end
                     ...
                     if getgenv().AutoPirateRaid then
                        ...
                        if randomnumber == 1 then
                           CheckFloat1()
                           getRoot(Char).CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, 0, 30)      
                        elseif randomnumber ==2 then
                           CheckFloat1()
                           getRoot(Char).CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, 0, -30) 
                        elseif randomnumber ==3 then
                           CheckFloat1()
                           getRoot(Char).CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, -30, 0)
                        end    
                     end
                  end
               until not MobHumanoid or not MobHRP or not MobP or not getgenv().AutoPirateRaid or MobHumanoid.Health <= 0 or not Alive()
      ...
      while getgenv().AutoSaber do
         ...
         if PlrLevel >= 200 then
            ...
            if Plates == 5 and getgenv().AutoSaber and not UsedTorch then
               wait(0.3)
               if not getRoot(Char):FindFirstChild("Torch") and not game.Players.LocalPlayer.Backpack:FindFirstChild("Torch") then
            ...
            if not UsedCup and UsedTorch and getgenv().AutoSaber then
               if not getRoot(Char):FindFirstChild("Cup") and not game.Players.LocalPlayer.Backpack:FindFirstChild("Cup") then
            ...
            if TalkedSon and not KilledMob and getgenv().AutoSaber and UsedTorch and UsedCup then
               if game.Workspace.Enemies:FindFirstChild("Mob Leader [Lv. 120] [Boss]") then
                  ...
                  repeat wait(.1)
                     ...
                     pcall(function()
                        --HitBoxPlr()
                        if (getRoot(Char).Position - MobLeader.HumanoidRootPart.Position) <= 350 then
                           getRoot(Char).CFrame = MobLeader.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                        else
                           DoTween(MobLeader.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)
                        ...
                        MobLeader.HumanoidRootPart.Size = Vector3.new(60,60,60)
                     end)
            ...
            if not KilledShanks and getgenv().AutoSaber and UsedRelic and UsedTorch and UsedCup and KilledMob  then
               if game.Workspace.Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
                  ...
                  repeat wait()
                     ...
                     pcall(function()
                       -- HitBoxPlr()
                        if (getRoot(Char).Position - Shank.HumanoidRootPart.Position) <= 350 then
                           getRoot(Char).CFrame = Shank.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                        else
                           DoTween(Shank.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)
                        ...
                        Shank.HumanoidRootPart.Size = Vector3.new(60,60,60)
                     end)
      ...
      while getgenv().AutoSecondSea do
         ...
         if PlrLevel >= 700 then
            ...
            if not KilledIceBoss and UsedKey then
               ...
               if game.Workspace.Enemies:FindFirstChild("Ice Admiral [Lv. 700] [Boss]") then
                  ...
                  repeat wait(0.1)
                     ...
                     pcall(function()
                        --HitBoxPlr()
                        if (getRoot(Char).Position - IceAdmiral.HumanoidRootPart.Position) <= 350 then
                           getRoot(Char).CFrame = IceAdmiral.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                        else
                           DoTween(IceAdmiral.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                        end
                        getRoot(Char).CFrame = IceAdmiral.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                        IceAdmiral.HumanoidRootPart.Size = Vector3.new(60,60,60)
            ...
            if KilledIceBoss and UsedKey and TalkedDetective then
               ...
               wait(0.5)
               if (getRoot(Char).Position-Vector3.new(-1165.95776, 7.65220022, 1728.58057)).magnitude <30 then
                  local args = {
                     [1] = "TravelDressrosa"
                  }
                  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
      ...
      while getgenv().AutoBartilo do
         ...
         if PlrLevel >= 800 then
            ...
            if not KilledSpring and KilledBandits then
               ...
               if game.Workspace.Enemies:WaitForChild("Jeremy [Lv. 850] [Boss]") then
                  ...
                  repeat wait()
                     ...
                     pcall(function()
                        HitBoxPlr()
                        getRoot(Char).CFrame = Jeremy.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
            ...
            if not DidPlates and KilledSpring and KilledBandits then
               ...
               getRoot(Char).CFrame = Plate1.CFrame

               firetouchinterest(getRoot(Char), Plate1, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate1, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate2.CFrame
               firetouchinterest(getRoot(Char), Plate2, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate2, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate3.CFrame

               firetouchinterest(getRoot(Char), Plate3, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate3, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate4.CFrame

               firetouchinterest(getRoot(Char), Plate4, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate4, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate5.CFrame

               firetouchinterest(getRoot(Char), Plate5, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate5, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate6.CFrame

               firetouchinterest(getRoot(Char), Plate6, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate6, 1)
               wait(0.2)
               getRoot(Char).CFrame = Plate7.CFrame

               firetouchinterest(getRoot(Char), Plate7, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate7, 1)
               wait(0.2)
               DoTween(Plate8.CFrame,getgenv().TweenSpeedTeleportPlace)

               firetouchinterest(getRoot(Char), Plate8, 0)
               wait()
               firetouchinterest(getRoot(Char), Plate8, 1)
            end
         end
      end
   end)
         ...
         if game:GetService("Workspace").Map.Turtle.TushitaGate.TushitaGate.Transparency ~= 1 then
            ...
            if NewIndra then
               ...
               elseif game.Players.LocalPlayer.Character:FindFirstChild("Holy Torch") then
                  ...
                  getRoot(Char).CFrame = CFrame.new(5148.03613, 162.352493, 910.548218, 0, 0, -1, 0, 1, 0, 1, 0, 0)
                  wait(1)
               end
            end
         end
         ...
         elseif not KilledCaptainElephantCitizen and getgenv().AutoCitizenQuest then
            if game.Workspace.Enemies:WaitForChild("Captain Elephant [Lv. 1875] [Boss]") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     --HitBoxPlr()
                     if (getRoot(Char).Position - CaptainElephant.HumanoidRootPart.Position) <= 350 then
                        getRoot(Char).CFrame = CaptainElephant.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     else
                        DoTween(CaptainElephant.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                     end
                     getRoot(Char).CFrame = CaptainElephant.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     CaptainElephant.HumanoidRootPart.Size = Vector3.new(60,60,60)
         ...
         --if PlrLevel >= 2000 then
            ...
            if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Stone") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     HitBoxPlr()
                     if (getRoot(Char).Position - StoneBoss.HumanoidRootPart.Position) <= 350 then
                        getRoot(Char).CFrame = StoneBoss.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     else
                        DoTween(StoneBoss.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                     end
                     getRoot(Char).CFrame = StoneBoss.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     StoneBoss.HumanoidRootPart.Size = Vector3.new(60,60,60)
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Island Empress") then
               ...
               repeat wait()
                  if Char:FindFirstChild(Weapon) == nil then
                     Equip(Weapon)
                  end
                  spawn(function()
                     Click()
                  ...
                  pcall(function()
                     HitBoxPlr()
                     if (getRoot(Char).Position - getRoot(IslandEmpress).Position) <= 350 then
                        getRoot(Char).CFrame = getRoot(IslandEmpress).CFrame * CFrame.new(0,20,0)
                     else
                        DoTween(getRoot(IslandEmpress).CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                     end
                     getRoot(Char).CFrame = getRoot(IslandEmpress).CFrame * CFrame.new(0,20,0)
                     getRoot(IslandEmpress).HumanoidRootPart.CanCollide = false
                     getRoot(IslandEmpress).HumanoidRootPart.Size = Vector3.new(60,60,60)
                     getRoot(IslandEmpress).HumanoidRootPart.Transparency = 0.5
                     getRoot(IslandEmpress).HumanoidRootPart.BrickColor = BrickColor.new("White")
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Kilo Admiral") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     ...
                     if (getRoot(Char).Position - KiloAdmiral.HumanoidRootPart.Position) <= 350 then
                        getRoot(Char).CFrame = KiloAdmiral.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     else
                        DoTween(KiloAdmiral.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                     end
                     getRoot(Char).CFrame = KiloAdmiral.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     KiloAdmiral.HumanoidRootPart.Size = Vector3.new(60,60,60)
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Beautiful Pirate") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     if (getRoot(Char).Position - BeautifulPirate.HumanoidRootPart.Position) <= 350 then
                        getRoot(Char).CFrame = BeautifulPirate.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     else
                        DoTween(BeautifulPirate.HumanoidRootPart.CFrame*CFrame.new(0, 20, 10),getgenv().TweenSpeedAutoFarm)

                     end
                     getRoot(Char).CFrame = BeautifulPirate.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     BeautifulPirate.HumanoidRootPart.Size = Vector3.new(60,60,60)
   ...
   while getgenv().AutoChest and wait() do
      ...
      if close ~= nil then
         ...
         repeat wait() 
            ...
            game.Players.LocalPlayer.Character.Humanoid:MoveTo(close.Position) 
...
CheckKenHaki = AutoStuffs:addTextLabel("Ken Exp: N/A",function()
end)
if ThirdSea then
...
Fruits:addToggle("Get Fruit",false,function(boolen) 
   ...
   while getgenv().GetFruits and wait(0.1) do 
      for i,v in pairs(game.Workspace:GetChildren()) do
         if v:IsA("Tool") then
            if (v.Handle.Position-getRoot(Char).Position).magnitude <= 800 then
               if getgenv().BringFruit then
                  v.Handle.CFrame = getRoot(Char).CFrame
               end
            else
...
TeleportSection:addKeybind("Stop Tweening", Enum.KeyCode.P, function()
   ...
   local tween =  game:service"TweenService":Create(getRoot(Char), info, {CFrame = getRoot(Char).CFrame})
...
if not FirstSea then
   TeleportSection:addButton("Teleport to Sea Beast", function()
      ...
      for i,v in pairs(game.Workspace.SeaBeasts:GetChildren()) do
         if getRoot(v) then
            if (getRoot(v).Position-getRoot(Char).Position).magnitude < NearestDistSeaBeast then
               NearestSeaBeast = v
               NearestDistSeaBeast = (getRoot(v).Position-getRoot(Char).Position).magnitude
            end
         end
      end
      pcall(function()
...
elseif ThirdSea then
   ...
   TeleportSection2:addButton("Mansion(Insta TP)", function()
      getRoot(Char).CFrame = game:GetService("Workspace").Map.Turtle.TradeTable.P1.CFrame
   end)
...
Pvp:addToggle("Kill Player(Melee)",false,function(boolen)
   ...
   while KillPlayerMelee do
      ...
      if PlrKillMelee ~=nil then
         ...
         if (getRoot(Char).Position - PlrToKillMelee.HumanoidRootPart.Position).magnitude < 500 then
            getRoot(Char).CFrame = PlrToKillMelee.HumanoidRootPart.CFrame
            PlrToKillMelee.HumanoidRootPart.Size = Vector3.new(200,200,200)
            --FastAttack()
            Click()
         elseif (getRoot(Char).Position - PlrToKillMelee.HumanoidRootPart.Position).magnitude < 10000 then
            DoTween(PlrToKillMelee.HumanoidRootPart.CFrame,getgenv().TweenSpeedTeleportPlace)
         end
      end
   end
end)
   ...
   while LoopTo do
      ...
      if PlrKillMelee ~=nil then
         ...
         if PlrToKillMelee and getRoot(PlrToKillMelee) then
            if (getRoot(Char).Position - PlrToKillMelee.HumanoidRootPart.Position).magnitude < 500 then
               getRoot(Char).CFrame = CFrame.new(PlrToKillMelee.HumanoidRootPart.Position)
            else
               DoTween(CFrame.new(PlrToKillMelee.HumanoidRootPart.Position),getgenv().TweenSpeedTeleportPlace)
            end
         end
      end
   end
                  ...
                  spawn(function()
                     if Hum and Humanoid.Health > 0 then
                        ...
                        if RandomThing == 1 then
                           getRoot(Char).CFrame = Hum.CFrame * CFrame.new(0,80,-10)
                        elseif RandomThing == 2 then
                           getRoot(Char).CFrame = Hum.CFrame * CFrame.new(0,80,10)
                        elseif RandomThing == 3 then
                           getRoot(Char).CFrame = Hum.CFrame * CFrame.new(0,60,30)
   ...
   while KillPlayerGunTeleport do
      ...
      if SelectedPlayer ~= nil then
         ...
         if PlrKillGunTp ~=nil then
            ...
            if (getRoot(Char).Position - PlrToKillGunTp.HumanoidRootPart.Position).magnitude < 500 then
               getRoot(Char).CFrame = PlrToKillGunTp.HumanoidRootPart.CFrame * CFrame.new(0,30,0)
               ...
               repeat wait()
                  spawn(function()
                     if PlrToKillGunTp:FindFirstChild("HumanoidRootPart") ~= nil then
                        CheckFloat1()
                        getRoot(Char).CFrame = PlrToKillGunTp.HumanoidRootPart.CFrame * CFrame.new(30, 85, 0)
                     end
                  end)
...
--[[Pvp:addToggle("Kill Player v2(Tween,Check Distance)",false,function(boolen)
   
   getgenv().KillPlayerV2 = boolen
   if getgenv().KillPlayerV2 and (SelectedPlayer == "" or SelectedPlayer == nil) then
      return false
   end
   for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
      if v:IsA("Tool") and v.ToolTip == "Melee"then
   ...
   local PlrKillGunTp = game.Players:FindFirstChild(SelectedPlayer)
   spawn(function()
      while getgenv().KillPlayerV2 do
         wait()
         if game.Players.LocalPlayer.Character.Humanoid.Health >= 3500 then
            getgenv().SafePvp = true
         else
            getgenv().SafePvp = false
         end
         pcall(function()
            CheckFloat1()
            --ClickMod.activeController.hitboxMagnitude = 80 
   ...
   if SelectedPlayer ~= nil then
      ...
      pcall(function()
         ...
         if PlrToKill~= nil then
            ...
            PlrToKill.HumanoidRootPart.Size = Vector3.new(60,60,60)
         end
      end)
   end
   loadstring(game:HttpGet("https://raw.githubusercontent.com/vinhuchi/BloxFruit/main/KillPlayerv2M1.lua"))()

   CheckFloat2()
end)
Pvp:addToggle("Kill Player v2(Tp,Need Close Range)",false,function(boolen)
   ...
   loadstring(game:HttpGet("https://raw.githubusercontent.com/vinhuchi/BloxFruit/main/KillPlayerv2M2.lua"))()
...
Pvp:addButton("Tp To Player",function()
   if SelectedPlayer ~= nil then
      local PlrKill = game.Players:FindFirstChild(SelectedPlayer)
      if PlrKill ~=nil then
         local PlrToKill = PlrKill.Character
         if PlrToKill ~= nil then
            local PlrHum = PlrToKill:FindFirstChild("HumanoidRootPart")
            if PlrHum then
               DoTween(PlrHum.CFrame,getgenv().TweenSpeedTeleportPlace)
            end
         end
      end
   end
...
mouse.Button1Down:Connect(function()
  if  Aimbot and game.Players.LocalPlayer.Character:FindFirstChild(SilentAimGun) ~= nil then
     spawn(function()
      if game:GetService("Players"):FindFirstChild(SelectedPlayer) and SelectedPlayer then
        local args = {[1] = game:GetService("Players"):FindFirstChild(SelectedPlayer).Character.HumanoidRootPart.Position, [2] = game:GetService("Players"):FindFirstChild(SelectedPlayer).Character.HumanoidRootPart}
        if game:GetService("Players"):FindFirstChild(SelectedPlayer).Character.HumanoidRootPart ~= nil  and game:GetService("Players").LocalPlayer.Character:FindFirstChild(SilentAimGun) then
           game:GetService("Players").LocalPlayer.Character:FindFirstChild(SilentAimGun).RemoteFunctionShoot:InvokeServer(unpack(args))
        end
      end
     end)
     spawn(function()
      ...
      repeat wait(.1)
         if plr2 and plr2.Character then
            if plr2.Character:FindFirstChild("Humanoid") ~= nil then
               wait(0.1)
               if plr2 and plr2.Character and plr2.Character:FindFirstChild("Humanoid") ~= nil then
...
Pvp:addToggle("HitBox Toggle",false,function(v)
   ...
   if SelectedPlayer ~= nil then
      ...
      if getgenv().Hitboxv == false then
         PlrToKill.HumanoidRootPart.Size = Vector3.new(4,2,4)
      end
   end
end)
Hitboxi = 10
   ...
   while getgenv().NoStun do
      ...
      if Char then
         if getHumanoid(Char) then
            if getHumanoid(Char).Humanoid.Health <= 0 then 
               wait(5)
            end
         end
         local Stun = Char.Stun
         Stun.Value = 0
         getRoot(Char).Size = Vector3.new(2,1,2)
      end
   end
end)
      ...
      Raid:addToggle("Fully Auto Law Raid",getgenv().FullyAutolawRaid,function(boolen)
         ...
         while getgenv().FullyAutolawRaid and wait() do
            ...
            if not game.Workspace.Enemies:FindFirstChild("Order [Lv. 1250] [Raid Boss]") then
               ...
               repeat wait()
                  if Alive() and LawBoss then
                     LawBoss.HumanoidRootPart.Size = Vector3.new(300,300,300)
                     LawBoss.HumanoidRootPart.CanCollide = false
                     ...
                     HitBoxPlr()
                     DisabledNoClip = true
                     if game.Players.LocalPlayer.Character.Humanoid.Health >= game.Players.LocalPlayer.Character.Humanoid.MaxHealth*20/100 then 
                        if LawBoss.Parent and LawBoss:FindFirstChild("Humanoid") and LawBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and LawBoss:FindFirstChild("Humanoid").Health > 0 and (LawBoss.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then
                           ...
                           if getRoot(Char).Position.y >= LawBoss.HumanoidRootPart.Position.y then
                                 ...
                                 spawn(function()
                                    ...
                                    if getgenv().FullyAutolawRaid and LawBoss.Parent and LawBoss:FindFirstChild("Humanoid") and LawBoss:FindFirstChild("HumanoidRootPart") ~= nil then
                                       if Alive() and LawBoss:FindFirstChild("Humanoid").Health > 0 and (LawBoss.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                          CheckFloat1()
                                          HumanoidRootPart.CFrame = LawBoss.HumanoidRootPart.CFrame * CFrame.new(0, 40, 40)
                                       else
                                          DoTween(LawBoss.HumanoidRootPart.CFrame * CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                                       end
                                    end
                           ...
                           elseif getgenv().FullyAutolawRaid then
                              local randomnumber = math.random(1,3)
                              if randomnumber == 1 then
                                 HumanoidRootPart.CFrame = LawBoss.HumanoidRootPart.CFrame * CFrame.new(0, 0, 40)      
                              elseif randomnumber ==2 then
                                 HumanoidRootPart.CFrame = LawBoss.HumanoidRootPart.CFrame * CFrame.new(0, 0, -40) 
                              elseif randomnumber ==3 then
                                 HumanoidRootPart.CFrame = LawBoss.HumanoidRootPart.CFrame * CFrame.new(0, -40, 0)
                              end    
                           end
                        ...
                        elseif not Tweening and LawBoss:FindFirstChild("HumanoidRootPart") ~= nil and LawBoss.Parent and LawBoss:FindFirstChild("Humanoid") and LawBoss:FindFirstChild("Humanoid").Health > 0 and Alive() then  
                           DoTween(LawBoss.HumanoidRootPart.CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                           if LawBoss.Parent and LawBoss:FindFirstChild("Humanoid") and LawBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and LawBoss:FindFirstChild("Humanoid").Health > 0 and (LawBoss.HumanoidRootPart.Position-getRoot(Char).Position).magnitude > 300 then
                              DoTween(LawBoss.HumanoidRootPart.CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                           end
                        end
                     else wait(5)
                     ...
                     repeat wait()
                     until game.Players.LocalPlayer.Character.Humanoid.Health >= game.Players.LocalPlayer.Character.Humanoid.MaxHealth*50/100
                  end
   ...
   Raid:addToggle("Kill Aura V2(For Bad Executors)",getgenv().KillAurav2,function(boolen)
      ...
      while getgenv().KillAurav2 and wait() do
         if LP.PlayerGui.Main.Timer.Visible == true then
            ...
            local NearestDist = math.huge
            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
               if getRoot(v) and getHumanoid(v) and getHumanoid(v) .Health > 0 then
                  if (getRoot(v).Position-getRoot(Char).Position).magnitude <= 1000 then
                     if (getRoot(v).Position-getRoot(Char).Position).magnitude < NearestDist then
                        NearestDist = (getRoot(v)-getRoot(Char).Position).magnitude
                        NearestMob = v
                     end
                  end
               end
            ...
            if NearestMob then
               pcall(function()
                  if (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude <= 350 then
                     ...
                     repeat wait()
                        ...
                        ResizeHRP(NearestMob,false)
                        if (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude <= 350 then
                           getRoot(Char).CFrame = getRoot(NearestMob).CFrame * CFrame.new(0, 10, 40)
                        end
                     until not NearestMob.Parent or not NearestMob or not getRoot(NearestMob) or not NearestMob:FindFirstChild("Humanoid") or NearestMob.Humanoid.Health <= 0 or not getgen().MobAura or (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude > 1000 or getgenv().KillAurav2 == false or not Alive()
