...
function library:AddWindow(text,keybind)
    ...
    NameHub.Font = Enum.Font.LuckiestGuy
    NameHub.Text = text
    NameHub.TextColor3 = Color3.fromRGB(138, 71, 236)
    ...
    UserImage.Image = "http://www.roblox.com/asset/?id=9341327948"
    ...
    UserText.Font = Enum.Font.Bangers
        ...
        while wait() do
            pcall(function()
                ...
                game:GetService('TweenService'):Create(
                    ...
                    {TextColor3 = Color3.fromRGB(138, 71, 236)}
                ):Play() 
            end)
        end
    end)
    ...
    ScrollPage.Size = UDim2.new(0, 145, 0, 290)
    ...
    function uitab:AddTab(text,image)
        ...
        PageButton.Font = Enum.Font.Code
        ...
        function main:AddToggle(text,config,callback)
            ...
            ToggleImage2.BackgroundColor3 = Color3.fromRGB(138, 71, 236)
        ...
        function main:AddDropdown(text,table,callback)
            ...
            for i,v in next,table do
                ...
                DropButton2.Font = Enum.Font.Code
        ...
        function main:AddSlider(text,min,max,set,callback)
            ...
            Bar.Name = "Bar"
            Bar.Parent = Bar1
            Bar.BackgroundColor3 = Color3.fromRGB(138, 71, 236)
        ...
        function main:AddSeperator(text)
            ...
            SepLabel.Font = Enum.Font.Bangers
            SepLabel.Text = text
            SepLabel.TextColor3 = Color3.fromRGB(225,225,225)
            SepLabel.TextSize = 14.00
        end
        function main:AddLine()
            ...
            Linee.Name = "Linee"
            Linee.Parent = Line
            Linee.BackgroundColor3 = Color3.fromRGB(138, 71, 236)
