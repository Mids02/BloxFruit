...
if game.CoreGui:FindFirstChild("Library") then
 ...
 local win = VLib:Window("MagmaHub V2", "Blox Fruit", Color3.fromRGB(252, 83, 83))
      ...
      game:GetService("RunService").Stepped:Connect(function()
       ...
       spawn(function()
        ...
        AutoFram:Toggle("Hide HitBox",true,function(Value)
           HideHitBlox = Value  
        end)
        AUTOHAKI = false
     ...
     _G.FastAtttk = false
         ...
         AutoFram:Toggle("Fast Attack",false,function(vu)
           _G.FastAtttk = vu
        end)
 
          AutoFram:Slider("Tp Speed",100,800,300,function(v)
           getgenv().speed = v
         end)
 ...
 spawn(function()
     while wait() do
        ...
        Distance = 500
        Raids:Toggle("Kill Aura (not Working Sorry)",false,function(value)
           if newworld then
              RaidsArua = value
       ...
       Misc:Button("Check Ectoplasm",function()
        ...
        Misc:Button("Open Inventory",function()
          ...
          Misc:Button("Open Fruit Inventory (works on OldWorld)",function()
           game.Players.localPlayer.PlayerGui.Main.FruitInventory.Visible = true
          end)
         Misc:Button("Open Titles",function()
           game.Players.localPlayer.PlayerGui.Main.Titles.Visible = true
         end)
      Misc:Button("Open Colors",function()
       ...
       spawn(function()
        ...
        AutoFram:Toggle("Anti AFK",true,function(vu)
      ...
      Setting:line()
      Setting:Button("Copy link v3rm",function()
         setclipboard("https://v3rmillion.net/member.php?action=profile&uid=2547419")
      end)
